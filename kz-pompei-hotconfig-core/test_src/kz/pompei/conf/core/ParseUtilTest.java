...
public class ParseUtilTest {
  ...
  public Object[][] primitiveAndBoxedTypes() {
    return new Object[][]{
      ...
      {"-654321", Integer.class, -654321},
      {"0x234", Integer.class, 564},
      {"0X38", int.class, 56},
      {"0b100110101", Integer.class, 309},
      {"0B0011010110", int.class, 214},
      {"0o16542", Integer.class, 7522},
      {"0O643", int.class, 419},
      {"00034", Integer.class, 34},
      {"01896", int.class, 1896},
      {"1234567890123", long.class, 1234567890123L},
      {"-1234567890123", long.class, -1234567890123L},
      {"3210987654321", Long.class, 3210987654321L},
      {"-3210987654321", Long.class, -3210987654321L},
      {"0xAfeE76a03", Long.class, 47226251779L},
      ...
      {"0xAfeE76a03", BigDecimal.class, new BigDecimal("47226251779")},
      {"0B1001110010", BigDecimal.class, new BigDecimal("626")},
      {"12345678901234567890", BigInteger.class, new BigInteger("12345678901234567890")},
      {"-12345678901234567890", BigInteger.class, new BigInteger("-12345678901234567890")},
      {"0xAfeE76a03", BigInteger.class, new BigInteger("47226251779")},
      {"0B1001110010", BigInteger.class, new BigInteger("626")},
      {"0o16542", BigInteger.class, new BigInteger("7522")},
      {"x", char.class, 'x'},
      {"y", Character.class, 'y'},
    };
  }
  ...
  public Object[][] integerValuesWithDecimalParts() {
    return new Object[][]{
      ...
      {"-1_234_567_890_123,50", Long.class, -1234567890124L},
      {"0x234", int.class, 564},
      {"0X38", Integer.class, 56},
      {"0b100110101", int.class, 309},
      {"0B0011010110", Integer.class, 214},
      {"0B1001110010", long.class, 626L},
      {"0o16542", Long.class, 7522L},
      {"0O643", int.class, 419},
      {"00034", Integer.class, 34},
      {"01896", int.class, 1896},
  ...
  public Object[][] numericExpressionValues() {
    return new Object[][]{
      ...
      {"0x10 + 2", int.class, 18},
      {"0X38 - 6", Integer.class, 50},
      {"0b100110101 + 1", int.class, 310},
      {"0B0011010110 * 2", Integer.class, 428},
      {"0o16542 / 2", long.class, 3761L},
      {"01896 - 34", int.class, 1862},
      {"3 + 7*3", int.class, 24},
      ...
      {"0x10 + 2.5", BigDecimal.class, new BigDecimal("18.5")},
      {"0B1001110010 / 2", BigDecimal.class, new BigDecimal("313")},
  ...
  public Object[][] envValues() {
    return new Object[][]{
      ...
      {"ENV_INT_HEX", "0x234", "$ENV{ENV_INT_HEX}", int.class, 564},
      {"ENV_INT_BIN", "0b100110101", "$ENV{ENV_INT_BIN}", int.class, 309},
      {"ENV_INT_OCT", "0o16542", "$ENV{ENV_INT_OCT}", int.class, 7522},
      ...
      {"ENV_BIG_DECIMAL_HEX", "0xAfeE76a03", "$ENV{ENV_BIG_DECIMAL_HEX}", BigDecimal.class, new BigDecimal("47226251779")},
      ...
      {"ENV_BIG_INTEGER_BIN", "0B1001110010", "$ENV{ENV_BIG_INTEGER_BIN}", BigInteger.class, new BigInteger("626")},
